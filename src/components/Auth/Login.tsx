                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div>
                        <input
                          ...
                          type="email"
                          placeholder="Email"
                          className="w-full text-black text-sm px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                          required
                        />
                      </div>
