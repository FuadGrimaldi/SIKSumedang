...
const SeniEkraf = ({ kecamatanId }: AllArticlesProps) => {
        ...
        <div className="container mx-auto">
          <div className="text-center mb-6 w-full">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-4">
              Seni Budaya & Ekonomi Kreatif di Kecamatan Rancakalong
            </h2>
            <p className="text-base text-gray-600">
              Jelajahi berbagai seni budaya dan ekonomi kreatif yang ada di
          ...
          <div className="text-center py-4">
            <div className="w-full bg-gray-50 rounded-lg p-8 inline-block">
              ...
              <h2 className="text-lg font-semibold text-gray-700 mb-2">
                Belum Ada Seni Budaya dan Ekonomi Kreatif
              </h2>
