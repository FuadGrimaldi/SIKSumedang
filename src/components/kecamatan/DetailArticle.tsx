...
const ArtikelDetailComp = ({ title }: ArtikelDetailsProps) => {
                        ...
                        <div className="mt-8 px-2 py-4 bg-gray-100 rounded-lg">
                          ...
                          <div className="w-full flex justify-center py-6">
                            {article.lokasi_kegiatan && (
                              ...
                              >
                                <MapPin className="w-5 h-5 text-gray-700 group-hover:text-white" />
...
export default ArtikelDetailComp;
