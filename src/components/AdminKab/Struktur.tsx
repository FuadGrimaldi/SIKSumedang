      ...
      setFilteredOfficials(
        officials.filter(
          (o) =>
            ...
            o.profile_kecamatan?.nama_kecamatan.toLowerCase().includes(value)
        )
      );
    }
  };
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 bg-white text-black"
          />
        </div>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    name="kecamatan_id"
                    defaultValue={
                      viewData?.kecamatan_id || editData?.kecamatan_id || ""
                    }
                    required
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-gray-700 text-left">Kecamatan</th>
            ...
            <tbody>
              {filteredOfficials.map((o, index) => (
                <tr key={o.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-700">
                    {o.profile_kecamatan?.nama_kecamatan}
                  </td>
