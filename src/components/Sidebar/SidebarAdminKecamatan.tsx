...
const AdminKecSidebar = () => {
  ...
  const menuItems = [
      ...
      subItems: [
        {
          ...
          label: "Profile Kecamatan",
          icon: PenOffIcon,
          path: "/adminkec/profile",
        },
        {
          id: "front-image",
          label: "Foto Unggulan",
          icon: PenOffIcon,
          path: "/adminkec/image-unggulan",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          id: "perangkat-Kecamatan",
          label: "Perangkat Kecamatan",
          icon: PenOffIcon,
          path: "/adminkec/struktur",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          label: "Artikel",
          icon: FileText,
          path: "/adminkec/artikel",
        },
        {
          id: "berita",
          label: "Berita",
          icon: FileText,
          path: "/adminkec/berita",
        },
        {
          id: "video",
          label: "Video",
    ...
    //       label: "Organisasi",
    //       icon: Landmark,
    //       path: "/adminkec/organisasi",
    //     },
    //     {
    //       id: "sarana",
    //       label: "Sarana",
    //       icon: School,
    //       path: "/adminkec/sarana",
    //     },
    //     {
    //       id: "wisata",
    //       label: "Wisata",
    //       icon: Award,
    //       path: "/adminkec/wisata",
    //     },
    //   ],
    // },
    {
    ...
    //   icon: BarChart3,
    //   subItems: [
    //     { id: "sdgs", label: "SDGs", icon: BarChart, path: "/adminkec/sdgs" },
    //   ],
    // },
  ];
...
export default AdminKecSidebar;
