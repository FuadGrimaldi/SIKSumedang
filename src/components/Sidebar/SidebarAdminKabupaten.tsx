...
const AdminKabSidebar = () => {
  ...
  const menuItems = [
      ...
      subItems: [
        {
          ...
          icon: PenOffIcon,
          path: "/adminkab/kecamatan",
        },
        {
          id: "front-image",
          label: "Foto Unggulan",
          icon: PenOffIcon,
          path: "/adminkab/image-unggulan",
        },
      ],
    },
    {
    ...
    //       label: "Sarana",
    //       icon: School,
    //       path: "/adminkab/sarana",
    //     },
    //     {
    //       id: "wisata",
    //       label: "Wisata",
    //       icon: Award,
    //       path: "/adminkab/wisata",
    //     },
    //   ],
    // },
    {
